...
function GoogleButton({ onAuth, onLoading, onError }) {
  ...
  return (
    <>
      <button className="ls-google-btn" onClick={() => login()}>
  ...
  return (
    <div className="ls-overlay">
      <div className="ls-card">
        ...
        {HAS_GOOGLE && (
          <GoogleButton onAuth={onAuth} onLoading={setLoading} onError={setError} />
        )}
        ...
        <form className="ls-form" onSubmit={submit}>
          <div className="ls-field">
            ...
            <input className="ls-input" type="text" value={username}
              ...
              placeholder="Enter username" autoComplete="username" maxLength={20} />
          </div>
          <div className="ls-field">
            <label className="ls-label">Password</label>
            <input className="ls-input" type="password" value={password}
